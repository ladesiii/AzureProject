...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
        {{-- Vite - compila y sirve resources/css/app.css (que ahora importa styles.css) y resources/js/app.js --}}
...
<div class="auth-container d-flex flex-column flex-md-row min-vh-100">
    ...
    <div class="auth-side d-flex justify-content-center align-items-center text-white @yield('side-position')">
        <div class="text-center p-4">
            <h2 class="logo-text mb-3">@yield('side-title')</h2>
                <img src="{{ asset('img/logo.png') }}" alt="Logo" class="img-fluid logo-img">
        </div>
    </div>

    {{-- Sección formulario --}}
    <div class="auth-form d-flex justify-content-center align-items-center flex-fill p-4">
